    ...
    <div class="container-fluid">
        <div class="row-fluid">
          ...
          <div class="btn-toolbar">
              <button class="btn btn-primary" onClick="location='<?php echo U('contact/add');?>'"><i class="icon-plus"></i>添加留言</button>
            <div class="btn-group">
            </div>
          </div>
          <div class="well">
              <table class="table">
                ...
                <tbody>
                  <?php if(is_array($contact_list)): foreach($contact_list as $key=>$item): ?><tr>
                    <td><?php echo ($item["contact_name"]); ?></td>
                    <td><?php echo ($item["contact_phone"]); ?></td>
                    <td><?php echo (date("Y-m-d",$item["contact_time"])); ?></td>
                    <td>
                        <a href="<?php echo U('contact/edit',array('contact_id'=>$item['contact_id']));?>"><i class="icon-pencil"></i></a>
                        <a href="<?php echo U('contact/delete',array('contact_id'=>$item['contact_id']));?>" role="button"><i class="icon-remove"></i></a>
                    </td>
