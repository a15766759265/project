...
<div class="sidebar-nav">
    ...
    <ul id="dashboard-menu" class="nav nav-list collapse in">
        ...
        <li ><a href="list.html">产品管理</a></li>
        <li ><a href="list.html">产品分类管理</a></li>
        <li ><a href="<?php echo U('config/index');?>">设置管理</a></li>
        <li ><a href="list.html">留言管理</a></li>
        <li ><a href="list.html">管理员</a></li>
    </ul>
</div>
    <div class="content">
    <div class="header">
            ...
            <div class="well">
                <div id="myTabContent" class="tab-content">
                  <div class="tab-pane active in" id="home">
                    <form action="#" name="configForm" method="post" enctype="multipart/form-data">
                        <label>设置名称</label>
                        <input type="text" name="config_name" value="<?php echo ($config_info["config_name"]); ?>" class="input-xxlarge">
                        <label>设置值</label>
                        <input type="text" name="config_value" value="<?php echo ($config_info["config_value"]); ?>" class="input-xxlarge">
