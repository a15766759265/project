    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="btn-toolbar">
                <button class="btn btn-primary" onClick="location='<?php echo U('config/add');?>'"><i class="icon-plus"></i>添加设置</button>
              <div class="btn-group">
              </div>
            </div>
            <div class="well">
                <table class="table">
                  ...
                  <tbody>
                    <?php if(is_array($config_list)): foreach($config_list as $key=>$item): ?><tr>
                      <td><?php echo ($item["config_id"]); ?></td>
                      <td><?php echo ($item["config_name"]); ?></td>
                      <td><?php echo ($item["config_value"]); ?></td>
                      <td>
                          <a href="<?php echo U('config/edit',array('config_id'=>$item['config_id']));?>"><i class="icon-pencil"></i></a>
                          <a href="<?php echo U('config/delete',array('config_id'=>$item['config_id']));?>" role="button" ><i class="icon-remove"></i></a>
                      </td>
