    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="btn-toolbar">
                <button class="btn btn-primary" onClick="location='<?php echo U('admin/add');?>'"><i class="icon-plus"></i>添加管理员</button>
              <div class="btn-group">
              </div>
            </div>
            <div class="well">
                <table class="table">
                  ...
                  <tbody>
                    <?php if(is_array($admin_list)): foreach($admin_list as $key=>$item): ?><tr>
                      <td><?php echo ($item["admin_id"]); ?></td>
                      <td><?php echo ($item["admin_name"]); ?></td>
                    
                      <td>
                          <a href="<?php echo U('admin/edit',array('admin_id'=>$item['admin_id']));?>"><i class="icon-pencil"></i></a>
                          <a href="<?php echo U('admin/delete',array('admin_id'=>$item['admin_id']));?>" role="button" ><i class="icon-remove"></i></a>
                      </td>
