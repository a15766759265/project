    ...
    <div class="container-fluid">
        <div class="row-fluid">
          ...
          <div class="btn-toolbar">
              <button class="btn btn-primary" onClick="location='<?php echo U('Product/add');?>'"><i class="icon-plus"></i>添加产品</button>
            <div class="btn-group">
            </div>
          </div>
          <div class="well">
              <table class="table">
                ...
                <tbody>
                  <?php if(is_array($product_list)): foreach($product_list as $key=>$item): ?><tr>
                    ...
                    <td><?php echo (date("Y-m-d",$item["product_time"])); ?></td>
                    <td>
                        <a href="<?php echo U('product/edit',array('product_id'=>$item['product_id']));?>"><i class="icon-pencil"></i></a>
                        <a href="<?php echo U('product/delete',array('product_id'=>$item['product_id']));?>" role="button" onclick="if(confirm('确定要删除吗?')){return true;}else{return false;}"><i class="icon-remove"></i></a>
                    </td>
