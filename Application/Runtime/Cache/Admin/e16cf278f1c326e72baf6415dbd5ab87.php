    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="btn-toolbar">
                <button class="btn btn-primary" onClick="location='<?php echo U('Article/index');?>'"><i class="icon-list"></i> 文章列表</button>
              <div class="btn-group">
              </div>
            </div>
            <div class="well">
                <div id="myTabContent" class="tab-content">
                  <div class="tab-pane active in" id="home">
                    <form action="<?php echo U('article/add');?>" name="ArticleForm" method="post" enctype="multipart/form-data">
                        <label>文章标题</label>
                        <input type="text" name="article_title" value="" class="input-xxlarge">
                        <label>文章作者</label>
                        <input type="text" name="article_author" value="" class="input-xxlarge">
                        <label>添加时间</label>
                        <input type="date" name="article_time" value="" class="input-xxlarge">
                        <label>文章图片</label>
                        <input type="file" name="article_img" value="" class="input-xxlarge">
                        <label>文章描述</label>
                        <textarea value="Smith" rows="3" name="article_desc" class="input-xxlarge"></textarea>
                        <label>文章内容</label>
                        <textarea value="Smith" rows="3" name="article_content" class="input-xxlarge"></textarea>
                        <label></label>
