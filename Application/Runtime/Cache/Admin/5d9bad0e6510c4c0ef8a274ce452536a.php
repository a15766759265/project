            ...
            <div class="well">
                <div id="myTabContent" class="tab-content">
                  <div class="tab-pane active in" id="home">
                    <form method="post">
                        <label>留言名称</label>
                        <input type="text" value="" name="contact_name" class="input-xxlarge">
                        <label>留言电话</label>
                        <input type="text" value="" name="contact_phone" class="input-xxlarge">
                        <label>留言时间</label>
                        <input type="date" value="" name="contact_time" class="input-xxlarge">
                        <label>邮箱</label>
                        <input type="email" value="" name="contact_email" class="input-xxlarge">
                        <label>审核状态</label>
                        <input type="radio" checked name="contact_state" value="1" class="input-xxlarge">已审核
                        <input type="radio" name="contact_state" value="0" class="input-xxlarge">未审核
                        <label>留言内容</label>
                        <textarea value="Smith" name="contact_content" rows="3" class="input-xxlarge"></textarea>
                        <label></label>
