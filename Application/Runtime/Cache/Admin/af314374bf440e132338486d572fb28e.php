    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="btn-toolbar">
                <button class="btn btn-primary" onClick="location='list.html'"><i class="icon-list"></i> 分类列表</button>
              <div class="btn-group">
              </div>
            </div>
            <div class="well">
                <div id="myTabContent" class="tab-content">
                  <div class="tab-pane active in" id="home">
                    <form action="#" name="procateForm" method="post" enctype="multipart/form-data">
                        <label>分类名称</label>
                        <input type="text" name="procate_name" value="<?php echo ($procate_info["procate_name"]); ?>" class="input-xxlarge">
