    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="btn-toolbar">
                <button class="btn btn-primary" onClick="location='<?php echo U('procate/add');?>'"><i class="icon-plus"></i>添加分类</button>
              <div class="btn-group">
              </div>
            </div>
            <div class="well">
                <table class="table">
                  ...
                  <tbody>
                    <?php if(is_array($procate_list)): foreach($procate_list as $key=>$item): ?><tr>
                      <td><?php echo ($item["procate_id"]); ?></td>
                      <td><?php echo ($item["procate_name"]); ?></td>
                   
                      <td>
                          <a href="<?php echo U('procate/edit',array('procate_id'=>$item['procate_id']));?>"><i class="icon-pencil"></i></a>
                          <a href="<?php echo U('procate/delete',array('procate_id'=>$item['procate_id']));?>" role="button" ><i class="icon-remove"></i></a>
                      </td>
