            ...
            <div class="well">
                <div id="myTabContent" class="tab-content">
                  <div class="tab-pane active in" id="home">
                    <form action="<?php echo U('Procate/add');?>" name="procateForm" method="post" enctype="multipart/form-data">
                        <label>分类名称</label>
                        <input type="text" name="procate_name" value="" class="input-xxlarge">
