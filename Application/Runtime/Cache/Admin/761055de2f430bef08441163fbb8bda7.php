            ...
            <div class="well">
                <div id="myTabContent" class="tab-content">
                  <div class="tab-pane active in" id="home">
                    <form action="#" name="ArticleForm" method="post" enctype="multipart/form-data">
                        <label>文章标题</label>
                        <input type="text" name="article_title" value="<?php echo ($article_info["article_title"]); ?>" class="input-xxlarge">
                        <label>文章作者</label>
                        <input type="text" name="article_author" value="<?php echo ($article_info["article_author"]); ?>" class="input-xxlarge">
                        <label>添加时间</label>
                        <input type="date" name="article_time" value="<?php echo (date('Y-m-d',$article_info["article_time"])); ?>" class="input-xxlarge">
                        <label>文章图片</label>
                        <input type="file" name="article_img" value="" class="input-xxlarge">
                        <?php if($article_info['article_img'] != ''): ?><img src="/GreenCMS/<?php echo ($article_info["article_img"]); ?>" style="width:100px;height:100px;" /><?php endif; ?>
                        <label>文章描述</label>
                        <textarea value="Smith" rows="3" name="article_desc" class="input-xxlarge"><?php echo ($article_info["article_desc"]); ?></textarea>
                        <label>文章内容</label>
                        <textarea value="Smith" rows="3" name="article_content" class="input-xxlarge"><?php echo ($article_info["article_content"]); ?></textarea>
                        <label></label>
