            ...
            <div class="well">
                <div id="myTabContent" class="tab-content">
                  <div class="tab-pane active in" id="home">
                    <form action="#" name="adminForm" method="post" enctype="multipart/form-data">
                        <label>管理员名称</label>
                        <input type="text" name="admin_name" value="<?php echo ($admin_info["admin_name"]); ?>" class="input-xxlarge">
                        <label>管理员密码</label>
                        <input type="text" name="admin_pwd" value="<?php echo ($admin_info["admin_pwd"]); ?>" class="input-xxlarge">
