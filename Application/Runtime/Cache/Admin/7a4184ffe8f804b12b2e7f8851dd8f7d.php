    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="btn-toolbar">
                <button class="btn btn-primary" onClick="location='<?php echo U('Article/add');?>'"><i class="icon-plus"></i>发布文章</button>
              <div class="btn-group">
              </div>
            </div>
            <div class="well">
                <table class="table">
                  ...
                  <tbody>
                    <?php if(is_array($article_list)): foreach($article_list as $key=>$item): ?><tr>
                       <td style="text-align:left; padding-left:20px;">
            <input type="checkbox" name="id[]" value="<?php echo ($item["article_id"]); ?>" /><?php echo ($item["article_id"]); ?>
          </td>
                    
                      <td><?php echo ($item["article_title"]); ?></td>
                      <td><?php echo (date('Y-m-d',$item["article_time"])); ?></td>
                      <td>
                          <a href="<?php echo U('Article/edit',array('article_id'=>$item['article_id']));?>"><i class="icon-pencil"></i></a>
                          <a href="<?php echo U('Article/delete',array('article_id'=>$item['article_id']));?>" role="button" ><i class="icon-remove"></i></a>
                      </td>
            ...
            <div> <a href="javascript:void(0)" class="button border-red icon-trash-o piliangshanchu" style="padding:5px 15px;" > 批量删除</a></div>
...
<script>
 ...
 $(".piliangshanchu").click(function(){
            ...
            if(confirm("确认要删除？")){ 
            window.location.href = "/GreenCMS/index.php/Admin/Article/delete/article_id/"+ids+"html";
            }
        })

//localhost/GreenCMS/index.php/Admin/Article/delete/article_id/undefined
//http://localhost/GreenCMS/index.php/Admin/Article/delete/article_id/38,html
